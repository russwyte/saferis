...
```scala marklit:silent,id=err_users
import saferis.*
...
```scala marklit:zio-app,extends=err_users
...
```scala marklit:silent,id=err_unique
import saferis.*
...
```scala marklit:zio-app,extends=err_unique

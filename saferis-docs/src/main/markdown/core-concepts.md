...
```scala marklit:silent,id=core_props
import saferis.*
...
```scala marklit:extends=core_props
...
```scala marklit:silent,id=core_compound
import saferis.*
import saferis.Schema.*
...
```scala marklit:silent,id=core_interp
import saferis.*
import zio.*
...
```scala marklit:extends=core_interp

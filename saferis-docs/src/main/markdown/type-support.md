...
```scala marklit:silent,id=type_time
import saferis.*
...
```scala marklit:zio-app,extends=type_time
xa.run(for
...
```scala marklit:silent,id=type_uuid
import saferis.*
import saferis.docs.DocsTransactor.transactor as xa
import zio.*
...
```scala marklit:zio-app,extends=type_uuid
xa.run(for
...
```scala marklit:silent,id=type_json
import saferis.*
import saferis.docs.DocsTransactor.transactor as xa
import zio.*
import zio.json.*
...
```scala marklit:zio-app,extends=type_json

...
```scala marklit:silent,id=verify_users
import saferis.*
...
```scala marklit:zio-app,extends=verify_users
...
```scala marklit:silent,id=verify_options
import saferis.*
import saferis.Schema.*
import saferis.docs.DocsTransactor.transactor as xa
import zio.*
...
```scala marklit:zio-app,extends=verify_options
...
```scala marklit:silent,id=verify_complex
import saferis.*
import saferis.Schema.*
import saferis.docs.DocsTransactor.transactor as xa
import zio.*
...
```scala marklit:zio-app,extends=verify_complex

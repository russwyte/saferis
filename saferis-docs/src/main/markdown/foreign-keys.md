...
```scala marklit:silent,id=fk_basic
import saferis.*
...
```scala marklit:extends=fk_basic
...
```scala marklit:zio-app,extends=fk_basic
...
```scala marklit:silent,id=fk_actions
import saferis.*
import saferis.Schema.*
import zio.*
...
```scala marklit:extends=fk_actions
...
```scala marklit:silent,id=fk_named
import saferis.*
import saferis.Schema.*
import zio.*
...
```scala marklit:extends=fk_named
...
```scala marklit:silent,id=fk_compound
import saferis.*
import saferis.Schema.*
import saferis.docs.DocsTransactor.transactor as xa
import zio.*
...
```scala marklit:extends=fk_compound
...
```scala marklit:zio-app,extends=fk_compound
...
```scala marklit:silent,id=fk_multi
import saferis.*
import saferis.Schema.*
import zio.*
...
```scala marklit:extends=fk_multi

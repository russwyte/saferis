...
The documentation is generated by [marklit](https://github.com/russwyte/marklit): every example is compiled and executed against a real PostgreSQL database, so the output shown is real and the build fails if an example breaks.

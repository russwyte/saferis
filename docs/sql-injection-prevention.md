...
```
// Scala 3.3.8
// error: Alias requires a string literal. For runtime identifiers, use Placeholder.identifier() or dialect.escapeIdentifier() instead.
```
...
```
// Scala 3.3.8
jsonb_exists(data, '''); DROP TABLE profiles; --')
```
